...
// Type definitions
type CollectionKey = "plane-crash" | "drink-driving" | "disaster-emergency-management" | "health-safety-environment";
...
type CollectionQuestions = {
  [K in CollectionKey]: Question[];
}
...
// Constants
const collectionQuestions: CollectionQuestions = {
  "plane-crash": [
...
export default function ChatInput({ collections = [] }: Props): JSX.Element {
  ...
  const [selectedCategory, setSelectedCategory] = useState<SelectedQuestionState>({
    categoryIndex: null,
    questionIndex: null,
  });
